...
var $author$project$Main$HtmlContent = F2(
	function (html, text) {
...
var $author$project$Main$GotSelection = function (a) {
...
var $author$project$Main$selection = _Platform_incomingPort('selection', $elm$json$Json$Decode$value);
					...
					if (_v0.$ === 'Just') {
						switch (_v0.a.$) {
							...
							case 'InternalLinks':
								var _v3 = _v0.a;
								return $elm$browser$Browser$Events$onMouseDown(
									A2($author$project$Main$outsideTargetHandler, 'internalLinkPicker', $author$project$Main$Close));
							default:
								break _v0$3;
						}
					} else {
					...
					_Utils_update(
						model,
						{
							openedWidget: _Utils_eq(
								model.openedWidget,
								$elm$core$Maybe$Just($author$project$Main$InternalLinks)) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just($author$project$Main$InternalLinks)
						}),
					$elm$core$Platform$Cmd$none);
			case 'InsertInternalLink':
				...
				if (_v3.$ === 'Just') {
					...
					if (!_Utils_eq(start, end)) {
						...
						return _Utils_Tuple2(
							model,
							$author$project$Main$insertHtml(data));
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				} else {
			...
			case 'DebugEvent':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							debugEvent: $elm$core$Maybe$Just(v)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $author$project$Main$linkPicker = F7(
	function (id, isActive, linkPickerOpen, currentLink, openMsg, handler, pageList) {
							...
							[
								...
								if (currentLink.$ === 'Just') {
									...
									return _Utils_eq(link, page) ? $mdgriffith$elm_ui$Element$Background$color(
										A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)) : $author$project$Main$noAttr;
								} else {
				...
				[
					...
					A2(
						...
						linkPickerOpen ? A2(
							...
							A2($elm$core$List$map, linkView, pageList)) : $mdgriffith$elm_ui$Element$none)),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					$elm$html$Html$Attributes$id(id))
				]),
			A2(
					...
					label: A2(
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$el,
								_List_Nil,
								$mdgriffith$elm_ui$Element$text('lien page interne'))
							])),
					onPress: isActive ? $elm$core$Maybe$Just(openMsg) : $elm$core$Maybe$Nothing
				}));
	});
...
var $author$project$Main$GetSelection = {$: 'GetSelection'};
var $author$project$Main$decodeEditorMarkup = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$HtmlContent,
	A2(
		$elm$json$Json$Decode$at,
		_List_fromArray(
			['target', 'value']),
	...
	A2(
		...
		_List_fromArray(
			['target', 'textContent']),
		$elm$json$Json$Decode$string));
var $author$project$Main$trixEditor = A3(
	$elm$html$Html$node,
	'trix-editor',
	_List_fromArray(
		[
			...
			$elm$html$Html$Events$on,
			'trix-change',
			A2($elm$json$Json$Decode$map, $author$project$Main$GetHtmlContent, $author$project$Main$decodeEditorMarkup)),
			A2(
			$elm$html$Html$Events$on,
	...
	var customControls = A2(
		...
		_List_fromArray(
			[
				...
				_Utils_eq(
					model.openedWidget,
					$elm$core$Maybe$Just($author$project$Main$FontColorPicker)),
				fontColor,
				...
				_Utils_eq(
					model.openedWidget,
					$elm$core$Maybe$Just($author$project$Main$InternalLinks)),
				$elm$core$Maybe$Nothing,
...
var $author$project$Main$processLinks = function (node) {
			...
			while (true) {
				if (toProcess.b) {
					if (toProcess.a.a === 'href') {
						...
						var url = _v1.b;
						var xs = toProcess.b;
						return A2($elm$core$String$startsWith, 'internal:', url) ? A2(
							$elm$core$List$cons,
							_Utils_Tuple2(
								'href',
								A2(
									$elm$core$String$dropLeft,
									$elm$core$String$length('internal:'),
									url)),
							_Utils_ap(
...
var $author$project$Main$renderer = function (model) {
	var content = A2(
		$elm$core$Result$withDefault,
		$mdgriffith$elm_ui$Element$none,
		A2(
